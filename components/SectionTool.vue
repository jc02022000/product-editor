<template>
  <div id="content">
    <div class="flex items-end ml-9">
      <div class="flex w-[89%]">
        <div class="mt-5 border-[1px] rounded-l-lg bg-white border-r-0 h-8 flex items-center p-1">
          <font-awesome-icon icon="search" class="p-1 text-[#bdbdbd]" />
        </div>
